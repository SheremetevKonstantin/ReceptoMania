...
public class Subcategories {
    ...
    public static final Subcategories[] desserts = {
            ...
            new Subcategories("Торты",R.drawable.desserts_otherstort,"desserts_otherstort"),
            new Subcategories("Слоеный торт",R.drawable.desserts_sloytort,"desserts_sloytort"),
            new Subcategories("Бисквитный торт",R.drawable.desserts_biskvittort,"desserts_biskvittort"),
            new Subcategories("Творожный торт",R.drawable.desserts_tvorogtort,"desserts_tvorogtort"),
            new Subcategories("Печенье",R.drawable.desserts_pechene,"desserts_pechene"),
            new Subcategories("Творожное печенье",R.drawable.desserts_tvorogpechen,"desserts_tvorogpechen"),
            new Subcategories("Печенье с начинкой",R.drawable.desserts_nachinkapechen,"desserts_nachinkapechen"),
            new Subcategories("Песочное печенье",R.drawable.desserts_pesokpechen,"desserts_pesokpechen"),
    ...
    public static final Subcategories[] hot = {
            ...
            new Subcategories("Гарнир из круп",R.drawable.hot_garnirkrupi,"hot_garnirkrupi"),
